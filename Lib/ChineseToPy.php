...
class ChineseToPy {
     ...
     * @param string $sRetFormat 返回格式 [first:首字母|all:全拼音]
     * @param string $symbol 转换后字的拼音连接方式
     * @return string
     */
    public static function encodePY($utf8Data, $sRetFormat='first' ,$symbol = ''){
